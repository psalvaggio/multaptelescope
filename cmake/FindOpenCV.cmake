...
get_filename_component(OpenCV_PARENT_DIR ${OpenCV_DIR} PATH)
get_filename_component(OpenCV_PARENT_DIR_NAME ${OpenCV_DIR} NAME)
get_filename_component(OpenCV_PARENT2_DIR ${OpenCV_PARENT_DIR} PATH)
get_filename_component(OpenCV_PARENT2_DIR_NAME ${OpenCV_PARENT_DIR} NAME)

if (OpenCV_PARENT_DIR_NAME STREQUAL "cmake" AND
    OpenCV_PARENT2_DIR_NAME STREQUAL "lib")
  set(OpenCV_CFG_DIR ${OpenCV_DIR})
  set(OpenCV_DIR ${OpenCV_PARENT2_DIR})
else()
  set(OpenCV_CFG_DIR ${OpenCV_DIR})
endif()
...
##----------------------------------------------------
if(EXISTS "${OpenCV_CFG_DIR}")
        #When its possible to use the Config script use it.
        if(EXISTS "${OpenCV_CFG_DIR}/OpenCVConfig.cmake")

                ## Include the standard CMake script
                include("${OpenCV_CFG_DIR}/OpenCVConfig.cmake")
        ...
        else(EXISTS "${OpenCV_CFG_DIR}/OpenCVConfig.cmake")
        ...
        endif(EXISTS "${OpenCV_CFG_DIR}/OpenCVConfig.cmake")
