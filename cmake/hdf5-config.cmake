...
IF (HDF5_BUILD_FORTRAN)
  SET (HDF5_INCLUDE_DIR_FORTRAN "${HDF5_INCLUDE_DIR}/fortran" )
...
IF (HDF5_BUILD_HL_LIB)
  SET (HDF5_INCLUDE_DIR_HL "${HDF5_INCLUDE_DIR}/hl" )
ENDIF (HDF5_BUILD_HL_LIB)

IF (HDF5_BUILD_HL_LIB AND HDF5_BUILD_CPP_LIB)
  SET (HDF5_INCLUDE_DIR_HL_CPP "${HDF5_INCLUDE_DIR}/hl/cpp" )
ENDIF (HDF5_BUILD_HL_LIB AND HDF5_BUILD_CPP_LIB)

IF (HDF5_BUILD_TOOLS)
  SET (HDF5_INCLUDE_DIR_TOOLS "${HDF5_INCLUDE_DIR}/tools" )
  SET (HDF5_TOOLS_DIR "${HDF5_DIR}/lib/tools" )
ENDIF (HDF5_BUILD_TOOLS)

#-----------------------------------------------------------------------------
# Version Strings
#-----------------------------------------------------------------------------
SET (HDF5_VERSION_STRING 1.8.7)
SET (HDF5_VERSION_MAJOR  1.8)
SET (HDF5_VERSION_MINOR  7)
